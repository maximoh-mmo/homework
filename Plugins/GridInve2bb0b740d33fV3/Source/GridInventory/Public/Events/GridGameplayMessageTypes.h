...
#include "GridGameplayMessageTypes.generated.h"

class UGameplayMessageRouter;

// Match rule for message listeners
UENUM(BlueprintType)
enum class EGridGameplayMessageMatch : uint8
{
