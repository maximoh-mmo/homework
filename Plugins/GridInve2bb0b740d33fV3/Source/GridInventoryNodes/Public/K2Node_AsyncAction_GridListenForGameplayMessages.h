...
#include "K2Node_AsyncAction_GridListenForGameplayMessages.generated.h"
...
UCLASS()
class UK2Node_AsyncAction_GridListenForGameplayMessages : public UK2Node_AsyncAction
{
	GENERATED_BODY()
